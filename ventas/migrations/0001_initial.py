    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telefomo', models.CharField(blank=True, max_length=200, null=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('costo', models.DecimalField(blank=True, decimal_places=2, max_digits=13, null=True)),
                ('cantidad', models.DecimalField(decimal_places=2, max_digits=13, null=True)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now_add=True)),
            ],
            options={
